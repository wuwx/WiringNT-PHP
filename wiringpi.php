...
abstract class wiringpi {
	...
	static function serialPutchar($fd,$c) {
		serialPutchar($fd,$c);
	}
	...
	static function lcd128x64circle($x,$y,$r,$colour,$filled) {
	...
	static function lcd128x64putchar($x,$y,$c,$bgCol,$fgCol) {
	...
	static function scrollPhatPutchar($c) {
		return scrollPhatPutchar($c);
	}
